...
function smc_trajectory_s(em::ErgodicManagerR2T, vtm::VTM, threshold::Float64; verbose::Bool=true, umax::Float64=1.0)
...
function update_ck_s(em::ErgodicManagerR2T, xds::VVVF, n::Int, vtm::VTM, threshold::Float64)
	num_agents = length(xds)
	Lx = em.domain.lengths[1]
	Ly = em.domain.lengths[2]
...
# TODO: this can be done a lot quicker
function compute_Bj_s(em::ErgodicManagerR2T, xd::VVF,n::Int,h::Float64,ck::MF, num_agents::Int)
	Lx = em.domain.lengths[1]
	Ly = em.domain.lengths[2]
	dxn = xd[n][1] - x_min(em)
	dyn = xd[n][2] - y_min(em)
